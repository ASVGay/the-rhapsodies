  ...
  return (
    <div className={"mb-2 text-center"}>
      <button
        ...
        className={
          "inline-flex w-36 min-w-[9rem] justify-center gap-2 rounded-lg border border-sky-500 px-2 py-1 align-baseline text-sm text-sky-500 hover:bg-sky-500 hover:text-white focus:ring-2 focus:ring-sky-500"
        }
      >
        {isLoading ? (
