...
DELETE FROM "auth"."users" WHERE id IN ('4ec7af50-3ced-45a9-9c1c-0e1038404778', '569e7419-5424-4d18-9918-31016f6252d7', '1ce835c1-a708-4e73-a808-334e982dfe3d', 'cbe9b982-fbf9-4036-9e4a-b98b0b4f26d4', 'de315267-9634-4cb8-9c7c-d0edd66c62fe', 'ba1dd6e7-0955-417d-9f9c-3ad841e7277f');
...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user") VALUES ('00000000-0000-0000-0000-000000000000', '4ec7af50-3ced-45a9-9c1c-0e1038404778', 'authenticated', 'authenticated', 'old@cypress.com', '$2a$10$75nN5Q/T4k840.pxlUVSzO2YUo4r038ucd2sM1cNTyaS2hOmB416.', '2023-05-16 08:23:07.992463+00', NULL, '', NULL, '', NULL, '', '', NULL, '2023-05-16 08:50:07.776211+00', '{"provider": "email", "providers": ["email"]}', '{}', NULL, '2023-05-16 08:23:07.989348+00', '2023-05-16 08:50:07.777528+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false);
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user") VALUES ('00000000-0000-0000-0000-000000000000', '569e7419-5424-4d18-9918-31016f6252d7', 'authenticated', 'authenticated', 'new@cypress.com', '$2a$10$b6bT0PQv8JdC7Ub9vN0RYuHJrP21xkIK0lj2WfV7UIkVqQ9YT8R2u', '2023-05-16 08:23:29.855917+00', NULL, '', NULL, '', NULL, '', '', NULL, '2023-05-16 08:50:09.183747+00', '{"provider": "email", "providers": ["email"]}', '{}', NULL, '2023-05-16 08:23:29.854098+00', '2023-05-16 08:50:09.185724+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false);

INSERT INTO "auth"."identities" ("id", "user_id", "identity_data", "provider", "last_sign_in_at", "created_at", "updated_at") VALUES ('4ec7af50-3ced-45a9-9c1c-0e1038404778', '4ec7af50-3ced-45a9-9c1c-0e1038404778', '{"sub": "4ec7af50-3ced-45a9-9c1c-0e1038404778", "email": "old@cypress.com"}', 'email', '2023-05-16 08:23:07.990111+00', '2023-05-16 08:23:07.990136+00', '2023-05-16 08:23:07.990136+00');
INSERT INTO "auth"."identities" ("id", "user_id", "identity_data", "provider", "last_sign_in_at", "created_at", "updated_at") VALUES ('569e7419-5424-4d18-9918-31016f6252d7', '569e7419-5424-4d18-9918-31016f6252d7', '{"sub": "569e7419-5424-4d18-9918-31016f6252d7", "email": "new@cypress.com"}', 'email', '2023-05-16 08:23:29.854808+00', '2023-05-16 08:23:29.854828+00', '2023-05-16 08:23:29.854828+00');

INSERT INTO "public"."member" ("display_name", "id") VALUES ('Old', '4ec7af50-3ced-45a9-9c1c-0e1038404778');
...
VALUES ('52bcbb7a-02e3-4cc8-a353-7b4402efacd7', 'brainstormborrel', (current_timestamp + INTERVAL '1 hour') + (random() * INTERVAL '7 days'), (current_timestamp + INTERVAL '2 hours') + (random() * INTERVAL '7 days'), 'Studio');
INSERT INTO "public"."event" ("id", "event_type", "start_time", "end_time", "location")
VALUES ('52bcbb7a-02e4-4cc8-a353-7b4402efacd7', 'rehearsal', (current_timestamp + INTERVAL '14 hours') + (random() * INTERVAL '7 days'), (current_timestamp + INTERVAL '19 hours') + (random() * INTERVAL '7 days'), 'Studio');
INSERT INTO "public"."event" ("id", "event_type", "start_time", "end_time", "location")
VALUES ('52bcbb7a-02e5-4cc8-a353-7b4402efacd7', 'brainstormborrel', current_timestamp + (random() * INTERVAL '7 days'), (current_timestamp + INTERVAL '1 hour') + (random() * INTERVAL '7 days'), 'Studio');
INSERT INTO "public"."event" ("id", "event_type", "start_time", "end_time", "location")
VALUES ('52bcbb7a-02e6-4cc8-a353-7b4402efacd7', 'rehearsal', current_timestamp + (random() * INTERVAL '7 days'), (current_timestamp + INTERVAL '1 hour') + (random() * INTERVAL '7 days'), 'Studio');
...
INSERT INTO "public"."attendee" ("event_id", "member_id", "attending")
VALUES ('52bcbb7a-02e4-4cc8-a353-7b4402efacd7', 'cbe9b982-fbf9-4036-9e4a-b98b0b4f26d4', 'present');
INSERT INTO "public"."attendee" ("event_id", "member_id", "attending")
